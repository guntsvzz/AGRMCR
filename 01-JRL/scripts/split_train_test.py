...
with gzip.open(data_path + 'train.txt.gz', 'wt') as train_fout, gzip.open(data_path + 'test.txt.gz', 'wt') as test_fout:
...
with gzip.open(data_path + 'train_id.txt.gz', 'wt') as train_fout, gzip.open(data_path + 'test_id.txt.gz', 'wt') as test_fout:
...
with open(data_path + 'test.qrels', 'wt') as fout:
	for u_idx in tqdm(test_user_product_map):
